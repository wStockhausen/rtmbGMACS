...
#' @param pR - function-level random effect value (scalar or same size vector as `z`)
#' @param link - link function for random effect ("none", "add" for additive effect, "mlt" for multiplicative effect)
#' @return vector with the predicted weights-at-size
#' @details Calculates weight `w` as
...
#'
#' @title Predict allometric (weight-at-size) values given model-scale parameters
#' @description Function to predict allometric (weight-at-size) values given model-scale parameters.
...
#' used to predict the weight for that row. The "prd" column is the predicted weight.
#'
#' @export
